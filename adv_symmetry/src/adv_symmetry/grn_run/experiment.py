...
def initialize(num_individuals: int, rng) -> List[GRNGenotype]:
...
def run_generation(previous_population: List[GRNGenotype], itteration: int, rng):
    """
...
def save_population_to_file(population: List[GRNGenotype], file_path: Path):
    population_data = [
